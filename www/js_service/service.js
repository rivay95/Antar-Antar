...
$(document).ready(function(){
    ...
    localStorage.setItem('Text',username);
        ...
        $.ajax({
            type: "POST",
            url: "http://localhost/antarantar_service/login.php",
            dataType: "json",
...
//daftar
            $('document').ready(function() {
                $('#daftar').click(function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "http://localhost/antarantar_service/daftar.php",
                        data: data,
                        success: function() {
...
//pesan
            $('document').ready(function() {
                $('#lanjut').click(function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "http://localhost/antarantar_service/pesan.php",
                        data: data,
                        success: function() {
...
$(document).ready(function(){
        $.ajax({
       url: "http://localhost/antarantar_service/data_pesan.php",
        dataType: 'json',
        timeout: 5000,
